...
<Cards>
  ...
  <Card
    ...
    description="Recreate, deploy, and verify the signing certificate on Railway and other hosts."
    href="/docs/self-hosting/maintenance/signing-certificate-rotation"
  />
  <Card
