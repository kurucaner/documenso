...
```
  ...
  <Step>
    Follow the [Signing Certificate Rotation](/docs/self-hosting/maintenance/signing-certificate-rotation) runbook to deploy on Railway or Docker and verify `/api/certificate-status`
  </Step>
</Steps>
