declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PUBLIC_APP_COMPANY_NAME?: string;
    NEXT_PUBLIC_APP_DESCRIPTION?: string;
    NEXT_PUBLIC_APP_LOGO_URL?: string;
    NEXT_PUBLIC_APP_FAVICON_URL?: string;
    NEXT_PUBLIC_APP_HIDE_POWERED_BY?: string;
    NEXT_PUBLIC_APP_HIDE_EMAIL_LOGO?: string;
    NEXT_PUBLIC_APP_COMPANY_ADDRESS?: string;
    NEXT_PUBLIC_APP_ATTRIBUTION_URL?: string;
    ...
    NEXT_PRIVATE_INTERNAL_SECRET?: string;
    NEXT_PRIVATE_SIGNUP_INVITE_EXPIRY_DAYS?: string;
    NEXT_PRIVATE_DEFAULT_ORGANISATION_NAME?: string;
    NEXT_PRIVATE_DEFAULT_TEAM_NAME?: string;
